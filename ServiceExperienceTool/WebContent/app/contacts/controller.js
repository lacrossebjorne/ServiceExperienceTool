...
.controller('ContactsController', ['$scope', '$location', 'contacts.data', 'pushService', function($scope, $location, contactsData, pushService) {
    var imgIndex = 0;
    var imgUris = contactsData.imgUris;
    var imageSwitch = function() {
        return contactsData.imgUris[imgIndex++ % imgUris.length];
    }

    $scope.tabs = contactsData.tabs;
